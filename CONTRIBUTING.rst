...
``cyrxnopt`` documentation uses Sphinx_ as its main documentation compiler. This
...
.. todo:: If your project is hosted on GitHub, you can also mention the following tip:
    ...
    .. tip::
       ...
       propose changes in ``cyrxnopt``'s files. While this mechanism can
...
::
    ...
    conda create -n cyrxnopt python=3 six virtualenv pytest pytest-cov
...
.. _issue tracker: https://github.com/<USERNAME>/cyrxnopt/issues
